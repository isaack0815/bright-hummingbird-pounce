...
type AddWorkGroupDialogProps = {
  show: boolean;
  onHide: () => void;
};

export function AddWorkGroupDialog({ show, onHide }: AddWorkGroupDialogProps) {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      showSuccess("Arbeitsgruppe erfolgreich erstellt!");
  ...
  return (
    <Modal show={show} onHide={onHide}>
      <Modal.Header closeButton>
        <Modal.Title>Neue Arbeitsgruppe</Modal.Title>
      </Modal.Header>
