      ...
      <Accordion>
        {garnishments?.map((garnishment, index) => (
          <Accordion.Item eventKey={String(index)} key={garnishment.id}>
            ...
            <Accordion.Body>
              <Row className="mb-3">
                <Col><strong>Gesamtbetrag:</strong> {garnishment.total_amount.toFixed(2)} €</Col>
                <Col><strong>Bezahlt:</strong> {garnishment.paid_amount.toFixed(2)} €</Col>
                <Col><strong>Restbetrag:</strong> {garnishment.remaining_amount.toFixed(2)} €</Col>
              </Row>
