        ...
        <Col md={4}>
          <Card>
            ...
            <ListGroup variant="flush" style={{ maxHeight: '75vh', overflowY: 'auto' }}>
              ...
              {emails?.map(email => (
                <ListGroup.Item key={email.id} action active={selectedEmail?.id === email.id} onClick={() => setSelectedEmail(email)}>
...
export default SimpleEmailClient;